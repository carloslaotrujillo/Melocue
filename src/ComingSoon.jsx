...
const navigation = [
  {
    name: 'Github',
    href: 'https://github.com/charleslaot/melocue',
    icon: (props) => (
      <svg
        fill="currentColor"
        viewBox="0 0 18 18"
  ...
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/groups/1068028406986720',
    icon: (props) => (
      <svg
        fill="currentColor"
        viewBox="0 0 24 24"
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/melocue_usa/',
    icon: (props) => (
      <svg
        fill="currentColor"
        viewBox="0 0 24 24"
  ...
  {
    name: 'X',
    href: 'https://twitter.com/melocue_usa',
    icon: (props) => (
      <svg
        fill="currentColor"
        viewBox="0 0 24 24"
  ...
  {
    name: 'YouTube',
    href: 'https://www.youtube.com/channel/UC-frvzWo6yHLnic6HZV-Mlw',
    icon: (props) => (
      <svg
        fill="currentColor"
        viewBox="0 0 24 24"
